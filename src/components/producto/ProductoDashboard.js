            ...
            <div className="d-grid gap-2">
              <CardGroup>
                <Card>
                  ...
                  />
                  <Card.Body>
                    <Card.Title>Ingresar Productos</Card.Title>
                    <dir className="row justify-content-center mt-5 ps-1">
                      <Button variant="primary" href="ingresarproducto">
                        Ingresar
                      </Button>
                    </dir>
                  </Card.Body>
                ...
                <Card>
                  ...
                  />
                  <Card.Body>
                    <Card.Title>Modificar Productos</Card.Title>
                    <dir className="row justify-content-center mt-5 ps-1">
                      <Button variant="primary" href="modificarproducto">
                        Modificar
                      </Button>
                    </dir>
                  </Card.Body>
